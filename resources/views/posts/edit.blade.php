        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
            	...
            	<div class="panel-body">
				    <form class="form-horizontal" role="form" method="POST" action="/update/{{$post->id}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="body" rows="5" class="form-control" name="body" required>
                                {{ trim($post->body) }}
                                </textarea> 
                        ...
                        <div class="form-group{{ $errors->has('active') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="active" class="form-control" name="active" required>
                                  ...
                                  <option value="0" {{ $post->active == 1 ? 'selected' : '' }}>Inactive</option>
                                </select>
